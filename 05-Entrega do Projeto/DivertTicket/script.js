...
const qtdingressoInteira = document.getElementById("qtdingressoInteira");
...
/* data inicio */;
        ...
        reader.onload = function () {
            ...
            if (inputMeia.checked) {
                evento.ingressos.push({
                    tipo: "Meia",
                    quantidade: qtdingressoMeia.value,
                    preco: precoMeia.value
                });
            }
            if (inputInteira.checked) {
                evento.ingressos.push({
                    tipo: "Inteira",
                    quantidade: qtdingressoInteira.value,
                    preco: precoInteiro.value
                });
            }
